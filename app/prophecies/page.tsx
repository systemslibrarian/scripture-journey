...
export const metadata: Metadata = {
  ...
  description: "Search and explore 202 prophecy lessons that trace promises, patterns, and psalms pointing to Jesus.",
  openGraph: {
    title: "Browse Prophecy Lessons — Scripture Journey",
    description: "Search and filter 202 messianic prophecy lessons by type, scholar, and category.",
  },
}
