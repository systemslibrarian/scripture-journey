...
export const metadata: Metadata = {
  ...
  description: "A visual map of 202 prophecy lessons organized by category: Lineage, Identity, Ministry, Rejection, Passion, Resurrection, and Kingdom.",
  openGraph: {
    title: "Prophecy Map — Scripture Journey",
    description: "See how 202 messianic prophecies map across seven categories — from Lineage to Kingdom.",
  },
}
